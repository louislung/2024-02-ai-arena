...
contract FighterFarm is ERC721, ERC721Enumerable {
    ...
    constructor(
        ...
        // @note where to update this numElements
        numElements[0] = 3;
    }
    ...
    function transferOwnership(address newOwnerAddress) external {
        // @audit should ensure not empty address?
    ...
    function instantiateAIArenaHelperContract(
    ...
    function claimFighters(
        ...
        require(
            modelHashes.length == totalToMint &&
                modelTypes.length == totalToMint
        );
    ...
    function contractURI() public pure returns (string memory) {
        return
            "ipfs://bafybeifztjs4yuwhqi7bvzhw2ufksynkoiwxss2gnti6j4v25l7iwz7y44";
    }
    ...
    function _createNewFighter(
        ...
        FighterOps.FighterPhysicalAttributes
            memory attrs = _aiArenaHelperInstance.createPhysicalAttributes(
                newDna,
                generation[fighterType],
                iconsType,
                dendroidBool
